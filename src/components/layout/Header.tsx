  ...
  return (
    <header className="app-header">
      <div className="logo-wrap">
        <div style={{ width:'34px', height:'34px', borderRadius:'50%', background:'#111', border:'2px solid var(--green)', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'var(--font-display)', fontSize:'14px', color:'var(--green)', flexShrink:0 }}>
          AM
        </div>
